...
newlist=open('/home/zenalisa/data/whole_dataset/north_biglist_fixed.csv', 'w')
w=csv.writer(newlist, delimiter = ',')
w.writerow(['aia', 'hmi'])

oldlist=pd.read_csv('/home/zenalisa/data/whole_dataset/north_biglist.csv', delimiter=',')
